#### Questions: How many users we have? - Blocked for a while
...
##### Some Ideas:
* Well, if user have to vote for different candidates, then at least for scenario one, the max number of user is 400,000.
